...
void updateScores(int idWinner){//1 random 2 greedy
    ...
    for (auto& line : lines)
    {
        ...
        if (words.size() > 0){
            ...
            if(firstWord == "Against"){
                ...
                //cout << word << endl;
                if( ((wordTemp == "random") & (idWinner == 1)) | ((wordTemp == "greedy") & (idWinner == 2)) ){
                    getWinScore = 1;
                }
                else if( ((wordTemp == "random") & (idWinner == 2)) | ((wordTemp == "greedy") & (idWinner == 1)) ){
                    getLoseScore = 1;
                }
            }
